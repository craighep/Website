...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    ...
    function format_relative_time(time_ago) {
      ...
      if ( time_ago.hours > 2 || time_ago.minutes > 120)    return ' '+time_ago.hours + ' Hours Ago';
      if ( time_ago.minutes < 59 && time_ago.hours <= 1)  return ' '+time_ago.hours + ' Hours, ' + time_ago.minutes + ' Minutes Ago';
